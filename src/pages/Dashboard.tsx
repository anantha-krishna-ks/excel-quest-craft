  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="ml-0 lg:ml-52 min-h-screen flex flex-col">
        {loading && (
          <div className="flex justify-center items-center h-40 text-lg text-blue-600">Loading tools...</div>
        )}
        {error && (
            ...
            <div className="px-6 pb-6">
              <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <Card className="p-6 bg-green-50 border border-gray-200 shadow-sm">
                  ...
                  <div className="text-2xl font-bold text-gray-900 mb-1">{aiTools.filter(t => t.badge === "Launch App").length}</div>
